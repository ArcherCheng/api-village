...
(
	...
	CONSTRAINT Va1Village_TeamId FOREIGN KEY (TeamId) REFERENCES Au1Team (TeamId) ON UPDATE CASCADE ON DELETE CASCADE
);
Go
...
-- 建立關連檔案
--Alter Table Va1Village Add CONSTRAINT Va1Village_TeamId
--	FOREIGN KEY (TeamId)
...
-- DROP TRIGGER Va1Village_Trigger1
go
CREATE TRIGGER Va1Village_Trigger1 ON Va1Village AFTER UPDATE,DELETE NOT FOR REPLICATION AS
Begin
...
(
	...
	--CONSTRAINT Va1VillageEducation_TeamId FOREIGN KEY (TeamId) REFERENCES Au1Team (TeamId)
);
Go
...
-- DROP TRIGGER Va1VillageEducation_Trigger1
go
CREATE TRIGGER Va1VillageEducation_Trigger1 ON Va1VillageEducation AFTER UPDATE,DELETE NOT FOR REPLICATION AS
Begin
	DECLARE @tableName NVARCHAR(100);
...
(
	...
	--CONSTRAINT Va1VillageExperience_TeamId FOREIGN KEY (TeamId) REFERENCES Au1Team (TeamId)
);
Go
...
-- DROP TRIGGER Va1VillageExperience_Trigger1
go
CREATE TRIGGER Va1VillageExperience_Trigger1 ON Va1VillageExperience AFTER UPDATE,DELETE NOT FOR REPLICATION AS
Begin
	DECLARE @tableName NVARCHAR(100);
...
(
	...
	--CONSTRAINT Va1VillagePolicy_TeamId FOREIGN KEY (TeamId) REFERENCES Au1Team (TeamId)
);
Go
...
-- DROP TRIGGER Va1VillagePolicy_Trigger1
go
CREATE TRIGGER Va1VillagePolicy_Trigger1 ON Va1VillagePolicy AFTER UPDATE,DELETE NOT FOR REPLICATION AS
Begin
	DECLARE @tableName NVARCHAR(100);
...
(
	...
	--CONSTRAINT Va1VillagePhoto_TeamId FOREIGN KEY(TeamId) REFERENCES Au1Team(TeamId)
);
Go
...
-- DROP TRIGGER Va1VillagePhoto_Trigger1
go
CREATE TRIGGER Va1VillagePhoto_Trigger1 ON Va1VillagePhoto AFTER UPDATE,DELETE NOT FOR REPLICATION AS
Begin
	DECLARE @tableName NVARCHAR(100);
...
-- -- DROP TRIGGER Va1VillageNeighbor_Trigger1
-- go
-- CREATE TRIGGER Va1VillageNeighbor_Trigger1 ON Va1VillageNeighbor AFTER UPDATE,DELETE NOT FOR REPLICATION AS
-- Begin
-- 	DECLARE @tableName NVARCHAR(100);
