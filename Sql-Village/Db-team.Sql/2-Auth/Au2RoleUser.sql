...
-- 	CONSTRAINT Au2RoleUser_Au1Team10 FOREIGN KEY (TeamId) REFERENCES Au1Team10(TeamId),
-- 	CONSTRAINT Au2RoleUser_Au1Role FOREIGN KEY (RoleId) REFERENCES Au1Role(RoleId),
-- 	CONSTRAINT Au2RoleUser_Au1User FOREIGN KEY (UserId) REFERENCES Au1User(UserId)
-- );
-- Go
...
-- 	CONSTRAINT Au2RoleAction_Au1Team10 FOREIGN KEY (TeamId) REFERENCES Au1Team10(TeamId),
...
-- 	CONSTRAINT Au2RoleComponent_Au1Team10 FOREIGN KEY (TeamId) REFERENCES Au1Team10(TeamId),
